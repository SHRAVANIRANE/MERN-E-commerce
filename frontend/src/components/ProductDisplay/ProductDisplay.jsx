...
const ProductDisplay = (props) => {
  ...
  useEffect(() => {
    fetch("https://flatheads-backend.onrender.com/allreviews") // Update to match your reviews API URL
      .then((res) => res.json())
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      const response = await fetch("https://flatheads-backend.onrender.com/allreviews", {
        method: "POST",
        headers: {
